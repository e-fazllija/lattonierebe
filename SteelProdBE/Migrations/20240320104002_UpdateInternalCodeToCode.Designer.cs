...
namespace SteelProdBE.Migrations
{
    ...
    [Migration("20240320104002_UpdateInternalCodeToCode")]
    partial class UpdateInternalCodeToCode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SteelProdBE.Entities.TransportComponent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TransportComponents");
                });

            modelBuilder.Entity("SteelProdBE.Entities.TransportDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SteelProdBE.Entities.Xml.OperaColors", b =>
                {
                    ...
                    b.Property<int>("OperaComponentId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SteelProdBE.Entities.Accessory", b =>
                {
                    ...
                    b.HasOne("SteelProdBE.Entities.Typologies.DeliveryType", "DeliveryType")
                        .WithMany()
            ...
            modelBuilder.Entity("SteelProdBE.Entities.Customer", b =>
                {
                    b.HasOne("SteelProdBE.Entities.Typologies.CustomerType", "CustomerType")
                        .WithMany()
                    ...
                    b.HasOne("SteelProdBE.Entities.Typologies.PaymentType", "PaymentType")
                        .WithMany()
            ...
            modelBuilder.Entity("SteelProdBE.Entities.Profile", b =>
                {
                    ...
                    b.HasOne("SteelProdBE.Entities.Typologies.ProfileType", "ProfileType")
                        .WithMany()
            ...
            modelBuilder.Entity("SteelProdBE.Entities.TransportComponent", b =>
                {
                    b.HasOne("SteelProdBE.Entities.TransportDocument", "TransportDocument")
                        .WithMany()
            ...
            modelBuilder.Entity("SteelProdBE.Entities.Xml.OperaColors", b =>
                {
                    b.HasOne("SteelProdBE.Entities.Xml.OperaComponent", null)
                        .WithOne("OperaColors")
                        .HasForeignKey("SteelProdBE.Entities.Xml.OperaColors", "OperaComponentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SteelProdBE.Entities.Xml.OperaCuts", b =>
                {
                    b.HasOne("SteelProdBE.Entities.Xml.OperaMaterial", null)
                        .WithOne("OperaCuts")
                        .HasForeignKey("SteelProdBE.Entities.Xml.OperaCuts", "OperaMaterialId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
