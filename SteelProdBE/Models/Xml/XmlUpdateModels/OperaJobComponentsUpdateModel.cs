...
{
    public class OperaJobComponentsUpdateModel
    {
        public int JobId { get; set; }
        [XmlElement("component")]
        public List<OperaComponentUpdateModel>? OperaComponent { get; set; }
    }

    public class OperaComponentUpdateModel
    {
        ...
        // Qualita
        [XmlElement("colors")]
        public OperaColorsUpdateModel? OperaColors { get; set; }
    }
}
