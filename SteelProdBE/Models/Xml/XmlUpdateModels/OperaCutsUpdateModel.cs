...
namespace SteelProdBE.Models.Xml.XmlUpdateModels
{
    ...
    public class OperaCutsUpdateModel
    {
        public int OperaMaterialId { get; set; }
        [XmlElement("cut")]
        public List<OperaCutsUpdateModel>? OperaCut { get; set; }
    }

    public class OperaCutUpdateModel
    {
        ...
        public OperaMachiningsUpdateModel? OperaMachinings { get; set; }
    }
}
