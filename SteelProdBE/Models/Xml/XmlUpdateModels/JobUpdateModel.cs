...
namespace SteelProdBE.Models.Xml.XmlUpdateModels
{
    public class JobUpdateModel
    {
        ...
        public OperaJobCustomerUpdateModel? OperaJobCustomer { get; set; }
        // PrezzoCommessa
        [XmlElement("job_price_details")]
        public OperaJobPriceUpdateModel? OperaJobPrice { get; set; }
        [XmlElement("job_components")]
        public OperaJobComponentsUpdateModel? OperaJobComponents { get; set; }
        [XmlElement("materials")]
        public OperaMaterialsUpdateModel? OperaMaterials { get; set; }
    }
}
