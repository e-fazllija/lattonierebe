...
namespace SteelProdBE.Models.Xml.XmlSelectModels
{
    ...
    public class OperaCutsSelectModel
    {
        public int OperaMaterialId { get; set; }
        [XmlElement("cut")]
        public List<OperaCutSelectModel>? OperaCut { get; set; }
    }

    public class OperaCutSelectModel
    {
        ...
        public OperaMachiningsSelectModel? OperaMachinings { get; set; }
    }
}
