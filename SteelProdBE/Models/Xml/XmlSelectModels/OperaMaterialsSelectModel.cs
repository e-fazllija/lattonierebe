...
{
    public class OperaMaterialsSelectModel
    {
        public int JobId { get; set; }
        [XmlElement("material")]
        public List<OperaMaterialSelectModel>? OperaMaterial { get; set; }
    }

    public class OperaMaterialSelectModel
    {
        ...
        [XmlElement("colors")]
        public OperaMaterialColorsSelectModel? OperaMaterialColors { get; set; }
        [XmlElement("cuts")]
        public OperaCutsSelectModel? OperaCuts { get; set; }
    }
}
