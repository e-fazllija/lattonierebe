...
{
    public class OperaJobComponentsSelectModel
    {
        public int JobId { get; set; }
        [XmlElement("component")]
        public List<OperaComponentSelectModel>? OperaComponent { get; set; }
    }

    public class OperaComponentSelectModel
    {
        ...
        // Qualita
        [XmlElement("colors")]
        public OperaColorsSelectModel? OperaColors { get; set; }
    }
}
