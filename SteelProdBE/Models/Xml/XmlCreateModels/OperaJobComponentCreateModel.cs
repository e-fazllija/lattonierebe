...
namespace SteelProdBE.Models.Xml.XmlCreateModels
{
    ...
    public class OperaJobComponentsCreateModel
    {
        public int JobId { get; set; }
        [XmlElement("component")]
        public List<OperaComponentCreateModel>? OperaComponent { get; set; }
    }
    public class OperaComponentCreateModel
    {
        ...
        // Qualita
        [XmlElement("colors")]
        public OperaColorsCreateModel? OperaColors { get; set; }
    }
}
